      ...
      <Container maxWidth>
        <Card sx={{backgroundColor:'#eceff4', marginBottom:'1rem'}}>
          ...
          <Box>
            ...
            <Fab size="small" sx={{ backgroundColor:'#eceff4',boxShadow: 'none'}} onClick={handleOpenUserMenu}>
              <MoreVertIcon />
            </Fab>
            <Menu
                        ...
                        >
                          <MenuItem key={'Edit Group'} onClick={handleCloseUserMenu}>
                              <Button sx={{ textAlign: 'center' }} variant='contained' >Edit Group</Button>
                            </MenuItem>
                          <MenuItem key={'Leave Group'} onClick={handleCloseUserMenu}>
                              <Button sx={{ textAlign: 'center' }} variant='outlined' color='warning'>Leave Group </Button>
                          </MenuItem>
                          <MenuItem key={'Delete Group'} onClick={handleCloseUserMenu}>
                              <Button sx={{ textAlign: 'center' }} variant='outlined' color='error'>Delete Group</Button>
                            </MenuItem>
                        </Menu>
          </Box>
        </Card>
